...
//		Student studentDetails = optionalStudent
//				.orElseThrow(() -> new StudentAPIException("Student does not exist"));
//		ResponseEntity<BookDTO> exchangeObject=restTemplate.exchange(url+"/book/getBookDetails{bookId}", HttpMethod.PUT,null,Book.class,bookId);
//		StudentDTO objectOfStudentDTO=studentDetails.convertToDTO();
//		objectOfStudentDTO.setBookDTO(getObject);
