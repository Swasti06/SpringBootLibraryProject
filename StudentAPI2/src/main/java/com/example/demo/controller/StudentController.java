...
//	@GetMapping("/student/getStudentAndBook/{studentId}/{bookId)")
//	public StudentDTO getStudentAndBookDetails(@PathVariable int studentId, @PathVariable int bookId) {
//		return studentService.getStudentAndBookData(studentId, bookId);
//		
//	}
